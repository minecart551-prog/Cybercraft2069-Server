...
var CONFIG_SHOP_ITEMS = [
    // Tab 0 — Food
    [
        { id: "minecraft:cookie",  count: 1, price: 2,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:sweet_berry_cookie",  count: 1, price: 2,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:honey_cookie",  count: 1, price: 2,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:melon_popsicle",  count: 1, price: 2,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "potion:water", count: 1, price: 5,   lore: ["The tasteless taste of nature."] },
        { id: "farmersdelight:cooked_mutton_chops",  count: 1, price: 4,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:kelp_roll_slice",  count: 1, price: 6,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:salmon_roll",  count: 1, price: 8,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:barbecue_stick",  count: 1, price: 9,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:melon_juice",  count: 1, price: 8,  lore: [] },
        { id: "minecraft:golden_carrot",  count: 1, price: 8,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "minecraft:cooked_beef",  count: 1, price: 9,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "minecraft:pumpkin_pie",  count: 1, price: 9,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:mutton_wrap",  count: 1, price: 11,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
        { id: "farmersdelight:apple_cider",  count: 1, price: 16,  lore: [] },
        { id: "minecraft:air",  count: 1, price: 2,  lore: [] },
...
function createPotionItem(world, potionId) {
    var item = world.createItem("minecraft:potion", 1);
        ...
        for (var idx = 0; idx < items.length && idx < totalSlots; idx++) {
            ...
            try {
                ...
                if (cfg.id.indexOf("potion:") === 0) {
                    ...
                    item.setCustomName("§b Real " + displayName);
                } else {
