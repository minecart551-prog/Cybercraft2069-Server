...
var LOOT_POOL = [
{
    ...
    count: 1,
    label: "Chaplet",
    tag: { ArmourersWorkshop: { Identifier: "db:ltmAlcg3RU", SkinType: "armourers:chest" } }
},
{
    id:    "armourers_workshop:skin",
    count: 1,
    label: "Stealth Flash Boots",
    tag: { ArmourersWorkshop: { Identifier: "db:YuERa0834d", SkinType: "armourers:feet" } }
},
{
    id:    "armourers_workshop:skin",
    count: 1,
    label: "Claws",
    tag: { ArmourersWorkshop: { Identifier: "db:MxxLYjbqEM", SkinType: "armourers:chest" } }
},
{
    id:    "armourers_workshop:skin",
    count: 1,
    label: "Maxwell's Leg",
    tag: { ArmourersWorkshop: { Identifier: "db:Bm51l8uzKl", SkinType: "armourers:legs" } }
},
    {
        id:    "armourers_workshop:skin",
        count: 1,
        label: "Amne's Ears",
        tag: { ArmourersWorkshop: { Identifier: "db:K5ax0B5nnC", SkinType: "armourers:head" } }
    },
    {
        id:    "armourers_workshop:skin",
        count: 1,
        label: "wink",
        tag: { ArmourersWorkshop: { Identifier: "db:JFFPX9YTRB", SkinType: "armourers:head" } }
    },
    {
        id:    "armourers_workshop:skin",
        count: 1,
        label: "Wings",
        tag: { ArmourersWorkshop: { Identifier: "db:rnNz87ejv0", SkinType: "armourers:wings" } }
    },
    {
        id:    "armourers_workshop:skin",
        count: 1,
        label: "Nexia's Tie",
        tag: { ArmourersWorkshop: { Identifier: "db:OkWBmzX5Ux", SkinType: "armourers:chest" } }
    },
    {
        id:    "armourers_workshop:skin",
        count: 1,
        label: "蝴蝶结束带黑",
        tag: { ArmourersWorkshop: { Identifier: "db:WKqjYFEhPt", SkinType: "armourers:chest" } }
    },
    {
        id:    "armourers_workshop:skin",
        count: 1,
        label: "paws :3",
        tag: { ArmourersWorkshop: { Identifier: "db:cSP0l0cuzz", SkinType: "armourers:feet" } }
    },
    {
        id:    "armourers_workshop:skin",
        count: 1,
        label: "BlackTie",
        tag: { ArmourersWorkshop: { Identifier: "db:0BkznFvozF", SkinType: "armourers:chest" } }
    },
];
...
// ── Block init ────────────────────────────────────────────────
function init(event) {
    event.block.setModel("minecraft:white_shulker_box");
...
function interact(event) {
    ...
    guiRef.addLabel(ID_TITLE, "§5§b✦ COMMON LOOT BOX ✦", TITLE_X, TITLE_Y, TITLE_SCALE, TITLE_SCALE);
...
function customGuiButton(event) {
    ...
    if (keys < KEY_COST) {
        player.message("§cYou need §e" + KEY_COST + " Common Key§c to spin! You have §e" + keys + "§c.");
...
function countKeys(player) {
    ...
    for (var i = 0; i < inv.getSize(); i++) {
        var s = inv.getSlot(i);
        if (s && !s.isEmpty() && s.getName() === "kubejs:key_common") {
